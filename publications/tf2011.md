...
imageCaption: "Recovery of frame \(x_2\) of the Football sequence using frame \(x_1\) as reference, \(S_2 = 0.2\), \(S_1 = 0.5\). Clockwise from upper left: original frame \(x_2\); independent reconstruction (PSNR = 25.95dB); recovery with Tikhonov-regularized MH prediction (PSNR = 26.91dB); recovery with SH prediction (PSNR = 25.97 dB)"
abstract: >-
