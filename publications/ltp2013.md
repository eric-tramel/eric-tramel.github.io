...
imageCaption: "Thematic maps resulting from classification using 748 training samples for the Indian Pines HSI data set. (a) Ground truth; (b) k-NN; (c) CRC- Pre; (d) SRC; (e) LFDA-SVM; (f) NRS; (g) NRS-LFDA."
abstract: >-
