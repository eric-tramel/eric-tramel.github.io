...
date: 2026-02-07
description: "A single-file BM25 MCP server that gives a Claude Code agent searchable access to its own conversation history."
tags: ["mcp", "bm25", "agents", "claude-code"]
author: erictramel
---
